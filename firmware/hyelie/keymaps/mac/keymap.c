...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_PLUS, KC_4,    KC_5,    KC_6,    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
        KC_1,    KC_2,    KC_3,    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                           KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT, KC_UP,
        KC_ENT,  KC_DOT,  KC_0,             KC_RCTL, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,                         KC_F20,  KC_F18,  KC_DEL,  KC_F21,  KC_F22,  KC_LEFT, KC_DOWN, KC_RGHT
    )
};
